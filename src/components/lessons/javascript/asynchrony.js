...
const content = (props) => (
  <div>
    ...
    <CodeSnippet code={`request = await cryptosat.sign('hello, world!');`} theme={props.theme} />
    <p>
      The request object can be queried in the following manner to determine the
      status of the request:
    </p>
    <CodeSnippet code={`await request.status();`} theme={props.theme} />
    <p>
    ...
    <CodeSnippet code={`await request.result();`} theme={props.theme} />
    <p>
